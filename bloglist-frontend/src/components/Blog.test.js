...
test('show url and likes when button pushed', () => {
    ...
    const component = render(
        <Blog blog={blog} blogs={blogs} user={user} setBlogs={() => {}} handleInfoButton={mockHandler}/>
    )
  ...
  test('like-button pushed twice', async () => {
    ...
    const component = render(
        <Blog blog={blog} blogs={blogs} user={user} setBlogs={() => {}} handleLikeButton={likeBtnHandler(blog)} handleInfoButton={BtnHandler}/>
    )
